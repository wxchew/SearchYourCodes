...
public:
    ...
    */
    ...
    /// force at which speed becomes zero (must be > 0)
    /**
    ...
    /** 
     ...
     and also will not exceed 2x its unloaded speed. For a minus-end directed motor, the permitted
     range is [2*unloaded_speed, 0], thus also excluding backward steps.
     */
    bool    limit_speed;
